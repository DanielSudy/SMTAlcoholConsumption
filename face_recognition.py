...
#subscription_key = "1e83a4fcc02c48bbb44fd69dc4d17cdd" #7day free Trail
subscription_key = "2bb55be86e34499794ace9370ec9e02a" #Trail Account DS Azure Konto
assert subscription_key

#face_api_url = 'https://westcentralus.api.cognitive.microsoft.com/face/v1.0/detect' #7day free Trail
face_api_url = 'https://francecentral.api.cognitive.microsoft.com/face/v1.0/detect' #Trail Account DS Azure Konto
...
class MSAzureFaceRecogntion():
    def getFaceInfos(self,url):
        ...
        try:
            ...
            print("Processing Error in FaceRegcognition API")
            return False,None